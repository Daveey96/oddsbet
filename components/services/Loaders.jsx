  ...
  return (
    <>
      {state ? (
        ...
        <span
          className={`text-white/0 before:content-["load"] fade2 aft after:translate-x-[-200%] overflow-hidden after:left-0 after:top-0 after:h-full after:w-4/5 after:from-transparent dark:after:via-white/5 after:via-white/70 after:to-transparent after:bg-gradient-to-r ${
