      ...
      <AnimatePresence>
        {alert && (
          <motion.span
            ...
            key={38373}
            className={`rounded-b-xl whitespace-nowrap relative fx overflow-hidden gap-2 px-6 pt-1.5 pb-1.5 ${
              alert.type === "success"
                ? " backdrop-blur-xl dark:backdrop-blur-none text-green-500 dark:text-white font-bold dark:font-normal dark:bg-[#022502]"
                : "backdrop-blur-xl dark:backdrop-blur-none text-red-600 dark:text-white font-bold dark:font-normal dark:bg-[#200202]"
            } `}
          >
            {alert.type === "success" ? (
